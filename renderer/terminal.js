  ...
  function injectCss() {
    ...
    if (!document.getElementById('terminal-inline-styles')) {
      ...
      st.textContent = `
        ...
        .xterm-host { position: absolute; inset: 0; padding: 6px 8px; background: #16161a; display: none; }
        .xterm-host.active { display: block; }
        .xterm-host .xterm, .xterm-host .xterm-viewport, .xterm-host .xterm-screen { height: 100% !important; width: 100% !important; }
